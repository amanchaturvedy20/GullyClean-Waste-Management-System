...
import { User, Mail, Phone, Award, Calendar, Shield, MapPin } from 'lucide-react';
...
const Profile = () => {
    ...
    const getRoleBadge = (role) => {
        switch(role) {
            ...
            default:
                return { icon: <User size={16} />, color: "bg-emerald-100 text-emerald-700 border-emerald-200" };
        }
    };
            ...
            <div className="px-8 pb-10 relative">
                ...
                <div className="flex justify-center -mt-20 mb-6">
                    <div className="relative group">
                        ...
                        />
                        {/* Status dot */}
                        <div className="absolute bottom-2 right-2 w-5 h-5 bg-emerald-500 border-4 border-white rounded-full z-20"></div>
                    </div>
                </div>
                ...
                <div className="space-y-4 max-w-md mx-auto">
                    {/* Detail Item */}
                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100 hover:bg-emerald-50/50 hover:border-emerald-100 transition-colors group">
                        <div className="w-12 h-12 rounded-xl bg-white border border-gray-100 flex items-center justify-center shadow-sm group-hover:bg-emerald-100/50 group-hover:border-emerald-200 transition-colors">
                            <Mail className="w-6 h-6 text-gray-400 group-hover:text-emerald-600 transition-colors" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100 hover:bg-emerald-50/50 hover:border-emerald-100 transition-colors group">
                        <div className="w-12 h-12 rounded-xl bg-white border border-gray-100 flex items-center justify-center shadow-sm group-hover:bg-emerald-100/50 group-hover:border-emerald-200 transition-colors">
                            <Phone className="w-6 h-6 text-gray-400 group-hover:text-emerald-600 transition-colors" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100 hover:bg-emerald-50/50 hover:border-emerald-100 transition-colors group">
                        <div className="w-12 h-12 rounded-xl bg-white border border-gray-100 flex items-center justify-center shadow-sm group-hover:bg-emerald-100/50 group-hover:border-emerald-200 transition-colors">
                            <Calendar className="w-6 h-6 text-gray-400 group-hover:text-emerald-600 transition-colors" />
                        </div>
                        <div>
